            ...
            {[
              ...
              <div key={deal.title} className="group relative rounded-2xl overflow-hidden bg-slate-200 aspect-[4/3] cursor-pointer">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6">
                  ...
                  <Link href="#products" className="inline-flex items-center gap-1.5 px-4 py-2 bg-white text-slate-900 text-sm font-semibold rounded-lg hover:bg-slate-100 transition-colors">
